...
echo "   Web App: https://goexec.de"
echo "   API: https://goexec.de/api/v1"
echo "   API Docs: https://goexec.de/api/docs"
echo ""
echo "🔒 SSL Certificate: Automatic Let's Encrypt (managed by Caddy)"
