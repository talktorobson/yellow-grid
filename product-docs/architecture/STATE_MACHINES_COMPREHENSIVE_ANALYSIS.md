...
**Reference**: `product-docs/domain/03-project-service-order-domain.md`
...
**Reference**: `product-docs/domain/07-contract-document-lifecycle.md`
...
**Reference**: `product-docs/domain/05-assignment-dispatch-logic.md`
...
**Reference**: `product-docs/domain/` (No dedicated Go Execution document)
