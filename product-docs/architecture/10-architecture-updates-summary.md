...
- 🔄 `product-docs/architecture/02-technical-stack.md` - Updated stack overview
- 🔄 `product-docs/architecture/03-service-boundaries.md` - Added integration adapters
- 🔄 `product-docs/domain/01-domain-model-overview.md` - Multi-sales-system support
...
- ✅ `docs/ARCHITECTURE_UPDATES_SUMMARY.md` - This file
- 🔄 `product-docs/architecture/02-technical-stack.md` - In progress
- 🔄 `product-docs/architecture/03-service-boundaries.md` - In progress
- 🔄 `product-docs/domain/01-domain-model-overview.md` - In progress
