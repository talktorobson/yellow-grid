...
```typescript
// ENHANCE: product-docs/domain/03-project-service-order-domain.md
interface Project {
  // ... existing fields ...
...
```typescript
// ENHANCE: product-docs/domain/02-provider-capacity-domain.md (if Operator domain exists)
interface Operator {
  // ... existing fields ...
...
```sql
-- ENHANCE: product-docs/infrastructure/02-database-design.md
