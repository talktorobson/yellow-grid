...
- **Architecture Guide**: `docs/MOBILE_APP_ARCHITECTURE.md`
...
- **RBAC Model**: `product-docs/security/02-rbac-model.md`
- **API Design**: `product-docs/api/01-api-design-principles.md`
