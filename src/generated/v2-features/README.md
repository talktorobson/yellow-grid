...
import { ApiModule } from '@fsm/v2-features-api';
...
import { ApiModule, Configuration, ConfigurationParameters } from '@fsm/v2-features-api';
...
```
import { DefaultApi } from '@fsm/v2-features-api';
...
```
import { BASE_PATH } from '@fsm/v2-features-api';
