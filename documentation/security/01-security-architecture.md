...
- Role-Based Access Control (RBAC) - see `/documentation/security/02-rbac-model.md`
...
**Mitigations:**
- Comprehensive audit logging (see `/documentation/security/04-audit-traceability.md`)
...
**Mitigations:**
- Rate limiting per user/IP (see `/documentation/security/06-api-security.md`)
- Request size limits
...
See `/documentation/security/03-data-privacy-gdpr.md` for details.
