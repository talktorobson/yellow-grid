...
**📄 `/documentation/domain/11-service-provider-referential.md`** (1,100 lines)
...
**📄 `/documentation/integration/09-service-catalog-sync.md`** (600 lines)
...
### API Specifications
**📄 `/documentation/api/10-service-catalog-api.md`** (PENDING)
...
- `/documentation/domain/02-provider-capacity-domain.md` (Provider model)
- `/documentation/domain/03-project-service-order-domain.md` (Service order integration)
- `/documentation/architecture/01-architecture-overview.md` (System architecture)
- `/documentation/infrastructure/03-kafka-architecture.md` (Kafka setup)
