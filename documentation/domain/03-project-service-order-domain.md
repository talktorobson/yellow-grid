...
- **Related Documents**:
  - `/documentation/domain/01-domain-model-overview.md`
  - `/documentation/domain/02-provider-capacity-domain.md`
  - `/documentation/DOMAIN_MODEL_UPDATES.md` (v2.0 detailed implementation)
  - `/documentation/FEATURE_ADDITIONS_ANALYSIS.md` (v2.0 comprehensive analysis)
  - `/documentation/prd/ahs-field-service-prd.md`
