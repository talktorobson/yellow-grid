...
### Problem Statement
The Crew Field App (mobile) is documented as **offline-first** (documentation/development/09-crew-field-app.md:4-9), but there is **NO specification** for what happens when:
...
- Yellow Grid: documentation/development/09-crew-field-app.md
