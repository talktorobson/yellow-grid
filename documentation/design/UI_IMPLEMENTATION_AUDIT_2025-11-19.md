...
The AI-powered cockpit specification (`documentation/development/07-service-operator-ai-cockpit.md`) describes features that **do not exist** (0% implemented).

**Action Taken**: Moved to `/documentation/future-features/` with clear status headers.
...
**Action Taken**: Documented in `/documentation/future-features/README.md`.
...
1. **Created `/documentation/future-features/` directory**
...
- `/documentation/future-features/` - Future feature specifications
- `/documentation/future-features/README.md` - Guidance on future vs current
