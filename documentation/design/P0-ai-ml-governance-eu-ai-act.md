...
### Problem Statement
Yellow Grid v2.0 includes **AI-powered features** (documentation/domain/10-ai-context-linking.md):
...
- Yellow Grid: documentation/domain/10-ai-context-linking.md
- Yellow Grid: documentation/infrastructure/08-ml-infrastructure.md
