...
- **OpenTelemetry + Prometheus + Grafana + Tempo + Loki** (documentation/operations/01-observability-strategy.md)
- **Datadog** (documentation/integration/08-sales-system-adapters.md)
...
**Datadog References**:
```
documentation/integration/08-sales-system-adapters.md
...
**Files to update**:
- [ ] documentation/integration/08-sales-system-adapters.md (remove Datadog refs)
- [ ] documentation/operations/01-observability-strategy.md (confirm this is authoritative)
- [ ] documentation/operations/02-monitoring-alerting.md (add OTel examples)
...
- Yellow Grid: documentation/operations/01-observability-strategy.md
- Yellow Grid: documentation/operations/02-monitoring-alerting.md
