...
- documentation/domain/05-assignment-dispatch-logic.md (Transparency backend)
- documentation/domain/10-ai-context-linking.md (AI/ML features)
- documentation/operations/01-observability-strategy.md (Observability spec)
- documentation/development/09-crew-field-app.md (Mobile offline-first)
- documentation/infrastructure/08-ml-infrastructure.md (ML infrastructure)
